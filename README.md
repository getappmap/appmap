...
* **id** *Required* unique and monotonous identifier. That is that the id of any given event should be greater than the ids of all its predecessors. Example: 23522.
